...
ปิดไว้เป็นค่าเริ่มต้น ไม่มีส่วนไหนของระบบพึ่งพา — ดู [docs/AI.md](docs/AI.md)

สรุปการเรียนแต่ละครั้งให้ผู้ตรวจอ่าน และชี้ข้อสอบที่ข้อความไทยเพี้ยนจากการนำเข้า PDF

**โมเดลไม่เห็นภาพ คลิป ค่า embedding หรือคะแนนใดๆ** เห็นเฉพาะจำนวนและชื่อเหตุการณ์
ที่พิมพ์อยู่บนหน้ารายงานอยู่แล้ว — payload สร้างจาก whitelist และมีเทสต์ตรวจว่าไม่มีอะไรหลุด

**โมเดลไม่ตัดสินอะไร** ห้ามบอกว่าทุจริตหรือไม่ทุจริต ห้ามแนะนำให้ผ่านหรือไม่ผ่าน
ผลลัพธ์แสดงเป็น "ร่างสรุป" พร้อมข้อความกำกับ และมีเทสต์อ่าน prompt กันไม่ให้ใครลบ guardrail ทิ้ง

ใช้ [LiteLLM](https://github.com/BerriAI/litellm) (MIT) เป็น gateway — เปลี่ยนจาก GPT-5 mini
เป็นโมเดลที่รันเองได้ด้วยการแก้ config ไฟล์เดียว สำคัญมากกับลูกค้าที่ข้อมูลออกนอกประเทศไม่ได้
