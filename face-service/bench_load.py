...
target because it is what a monitored lesson calls on a timer for every learner
at once, which makes it the load the service actually sees.

What it does not: Moodle, the database, evidence writes, or the browser. A
number here is a ceiling for the face pipeline, not a capacity for the product.
...
if __name__ == "__main__":
    ...
    lines += [
        ...
        "",
        "Ceiling for the face pipeline only. Moodle, the database, evidence",
        "writes and the browsers are not in this measurement, and the service",
        "was sharing a laptop with all of them while it ran. Treat it as an",
        "order of magnitude, not a capacity plan.",
    ]
