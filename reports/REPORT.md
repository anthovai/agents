...
| `video/<ชื่อเทสต์>.webm` | วิดีโอการรันแต่ละเทสต์ (55 ไฟล์) หน่วงจังหวะไว้ให้ดูทัน |
| `screenshots/<ชื่อเทสต์>.png` | ภาพหน้าจอเต็มหน้าตอนจบแต่ละเทสต์ (55 ไฟล์) |
| `eventlog/<ชื่อเทสต์>.txt` | audit log ที่ระบบบันทึกไว้ในเทสต์นั้น (66 ไฟล์) |
...
| เทสต์ | ผล | วินาที |
|---|---|---|
| `test_face_service_is_up_with_every_model_loaded` | ผ่าน | 2.3 |
...
| `test_site_loads` | ผ่าน | 3.6 |
| `test_face_service_is_not_reachable_from_the_browser` | ผ่าน | 2.9 |
| `test_nothing_is_reachable_before_consent_is_given` | ผ่าน | 12.1 |
| `test_enrolment_becomes_reachable_once_consent_is_given` | ผ่าน | 16.6 |
| `test_consent_document_states_what_is_collected` | ผ่าน | 12.6 |
| `test_consent_is_compulsory_not_optional` | ผ่าน | 10.2 |
| `test_learner_can_see_their_own_consent_record` | ผ่าน | 12.0 |
...
| `test_the_page_reports_a_camera_that_will_not_start` | ผ่าน | 12.4 |
| `test_lesson_page_offers_the_video_and_a_camera_preview` | ผ่าน | 9.6 |
| `test_leaving_the_window_pauses_the_video_and_is_recorded` | ผ่าน | 15.6 |
| `test_a_violation_captures_evidence` | ผ่าน | 16.7 |
| `test_presence_check_runs_on_its_interval_and_pauses_the_lesson` | ผ่าน | 20.2 |
| `test_identity_check_runs_on_its_own_interval` | ผ่าน | 23.6 |
| `test_a_random_clip_is_recorded_and_stored` | ผ่าน | 25.2 |
| `test_the_learner_is_asked_to_confirm_they_are_still_there` | ผ่าน | 17.3 |
| `test_lockdown_blocks_and_reports_every_browser_exit` | ผ่าน | 15.2 |
| `test_text_selection_and_dragging_are_suppressed` | ผ่าน | 10.2 |
| `test_an_unknown_signal_is_refused_by_the_server` | ผ่าน | 11.0 |
| `test_quiz_announces_that_it_is_proctored` | ผ่าน | 10.7 |
...
| `test_a_server_written_pass_opens_the_attempt` | ผ่าน | 16.1 |
| `test_monitoring_runs_during_the_attempt` | ผ่าน | 22.4 |
| `test_answers_can_be_submitted_and_graded` | ผ่าน | 28.1 |
...
| `test_expired_evidence_is_purged` | ผ่าน | 17.1 |
| `test_privacy_api_deletes_the_face_on_erasure` | ผ่าน | 18.7 |
...
| `test_the_video_player_is_found_through_its_published_interface` | ผ่าน | 16.4 |
| `test_leaving_the_activity_window_is_recorded` | ผ่าน | 18.1 |
...
| `test_starting_a_lesson_opens_one_sitting` | ผ่าน | 12.9 |
| `test_reloading_does_not_start_a_second_sitting` | ผ่าน | 17.7 |
| `test_the_rules_in_force_are_recorded_on_the_sitting` | ผ่าน | 13.0 |
| `test_changing_the_settings_does_not_rewrite_a_finished_sitting` | ผ่าน | 15.8 |
| `test_a_terminated_sitting_records_why` | ผ่าน | 16.6 |
| `test_a_late_completion_cannot_launder_a_terminated_sitting` | ผ่าน | 20.4 |
| `test_a_client_cannot_mark_a_sitting_abandoned` | ผ่าน | 13.1 |
| `test_a_sitting_nobody_closed_is_marked_abandoned` | ผ่าน | 13.7 |
| `test_checks_and_evidence_are_filed_under_the_sitting` | ผ่าน | 19.4 |
| `test_the_report_groups_everything_by_sitting` | ผ่าน | 26.4 |
| `test_an_exam_attempt_is_its_own_sitting` | ผ่าน | 22.1 |
