...
| `video/<ชื่อเทสต์>.webm` | วิดีโอการรันแต่ละเทสต์ (80 ไฟล์) หน่วงจังหวะไว้ให้ดูทัน |
| `screenshots/<ชื่อเทสต์>.png` | ภาพหน้าจอเต็มหน้าตอนจบแต่ละเทสต์ (80 ไฟล์) |
| `eventlog/<ชื่อเทสต์>.txt` | audit log ที่ระบบบันทึกไว้ในเทสต์นั้น (91 ไฟล์) |
...
| เทสต์ | ผล | วินาที |
|---|---|---|
| `test_face_service_is_up_with_every_model_loaded` | ผ่าน | 2.9 |
...
| `test_nothing_is_reachable_before_consent_is_given` | ผ่าน | 12.6 |
| `test_enrolment_becomes_reachable_once_consent_is_given` | ผ่าน | 17.0 |
| `test_consent_document_states_what_is_collected` | ผ่าน | 12.9 |
| `test_consent_is_compulsory_not_optional` | ผ่าน | 9.2 |
| `test_learner_can_see_their_own_consent_record` | ผ่าน | 12.5 |
| `test_enrol_page_explains_what_will_happen` | ผ่าน | 10.4 |
| `test_challenge_asks_for_a_randomised_sequence` | ผ่าน | 10.1 |
| `test_enrolment_is_refused_when_no_face_is_visible` | ผ่าน | 29.5 |
| `test_the_page_reports_a_camera_that_will_not_start` | ผ่าน | 12.7 |
| `test_lesson_page_offers_the_video_and_a_camera_preview` | ผ่าน | 9.8 |
| `test_leaving_the_window_pauses_the_video_and_is_recorded` | ผ่าน | 15.8 |
| `test_a_violation_captures_evidence` | ผ่าน | 17.0 |
| `test_presence_check_runs_on_its_interval_and_pauses_the_lesson` | ผ่าน | 20.5 |
| `test_identity_check_runs_on_its_own_interval` | ผ่าน | 24.2 |
| `test_a_random_clip_is_recorded_and_stored` | ผ่าน | 24.2 |
...
| `test_an_unknown_signal_is_refused_by_the_server` | ผ่าน | 10.5 |
| `test_quiz_announces_that_it_is_proctored` | ผ่าน | 10.4 |
| `test_a_learner_with_no_enrolled_face_cannot_start` | ผ่าน | 11.9 |
| `test_the_preflight_check_asks_for_the_camera` | ผ่าน | 13.8 |
| `test_a_forged_client_marker_does_not_open_the_attempt` | ผ่าน | 16.0 |
| `test_a_server_written_pass_opens_the_attempt` | ผ่าน | 16.4 |
| `test_monitoring_runs_during_the_attempt` | ผ่าน | 22.8 |
| `test_answers_can_be_submitted_and_graded` | ผ่าน | 28.6 |
| `test_the_report_shows_checks_evidence_and_signals` | ผ่าน | 21.8 |
| `test_the_report_records_the_threshold_that_was_in_force` | ผ่าน | 17.0 |
| `test_one_learner_cannot_read_another_learners_evidence` | ผ่าน | 30.2 |
| `test_expired_evidence_is_purged` | ผ่าน | 17.8 |
| `test_privacy_api_deletes_the_face_on_erasure` | ผ่าน | 19.9 |
| `test_seb_is_configured_with_a_real_config_key` | ผ่าน | 1.0 |
| `test_an_ordinary_browser_cannot_start_the_seb_quiz` | ผ่าน | 13.1 |
| `test_the_seb_config_file_is_downloadable_by_the_learner` | ผ่าน | 12.8 |
...
| `test_monitoring_starts_when_the_learner_begins` | ผ่าน | 17.1 |
| `test_the_video_player_is_found_through_its_published_interface` | ผ่าน | 17.7 |
| `test_leaving_the_activity_window_is_recorded` | ผ่าน | 18.6 |
| `test_staff_viewing_the_activity_are_not_monitored` | ผ่าน | 10.7 |
| `test_staff_can_turn_proctoring_off_and_on` | ผ่าน | 16.2 |
| `test_an_unmonitored_activity_is_left_alone` | ผ่าน | 18.0 |
| `test_starting_a_lesson_opens_one_sitting` | ผ่าน | 13.1 |
| `test_reloading_does_not_start_a_second_sitting` | ผ่าน | 17.9 |
| `test_the_rules_in_force_are_recorded_on_the_sitting` | ผ่าน | 13.1 |
| `test_changing_the_settings_does_not_rewrite_a_finished_sitting` | ผ่าน | 16.0 |
| `test_a_terminated_sitting_records_why` | ผ่าน | 16.8 |
| `test_a_late_completion_cannot_launder_a_terminated_sitting` | ผ่าน | 18.0 |
...
| `test_the_report_groups_everything_by_sitting` | ผ่าน | 24.2 |
| `test_an_exam_attempt_is_its_own_sitting` | ผ่าน | 21.0 |
| `test_the_parser_reads_a_thai_exam_pack` | ผ่าน | 1.1 |
| `test_difficulty_is_spread_across_the_pack` | ผ่าน | 1.2 |
...
| `test_the_stats_page_reports_the_service_and_the_evidence` | ผ่าน | 11.5 |
| `test_the_stats_page_says_when_the_face_service_is_unreachable` | ผ่าน | 12.6 |
| `test_the_stats_page_warns_when_retention_is_not_being_enforced` | ผ่าน | 17.7 |
...
| `test_the_seed_is_only_a_function_of_the_identifiers` | ผ่าน | 2.1 |
| `test_the_recorded_draw_is_checked_against_the_identifiers` | ผ่าน | 15.7 |
| `test_a_tampered_seed_is_reported_as_tampered` | ผ่าน | 15.0 |
| `test_ai_is_off_until_somebody_turns_it_on` | ผ่าน | 1.0 |
| `test_what_gets_sent_contains_no_biometric_data` | ผ่าน | 16.3 |
| `test_the_summary_is_labelled_as_a_draft_not_a_finding` | ผ่าน | 19.1 |
| `test_a_service_that_is_not_there_fails_visibly` | ผ่าน | 4.5 |
| `test_the_model_is_told_not_to_accuse_anybody` | ผ่าน | 0.9 |
| `test_a_summary_comes_back_when_a_model_is_behind_the_service` | ผ่าน | 32.0 |
| `test_the_assistant_is_off_until_somebody_turns_it_on` | ผ่าน | 12.3 |
| `test_one_learners_courses_are_invisible_to_another` | ผ่าน | 3.0 |
| `test_a_question_the_site_cannot_answer_never_reaches_a_model` | ผ่าน | 2.8 |
| `test_retrieval_finds_the_right_page_without_a_model` | ผ่าน | 1.7 |
| `test_the_answer_links_only_to_pages_the_learner_can_open` | ผ่าน | 30.7 |
| `test_a_learner_asks_where_something_is_and_the_link_works` | ผ่าน | 41.0 |
