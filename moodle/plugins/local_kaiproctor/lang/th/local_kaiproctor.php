...
$string['ask:intro'] = 'ถามว่าอะไรอยู่ตรงไหน แล้วจะได้ลิงก์กลับไป — รู้เฉพาะหน้าที่คุณเปิดได้อยู่แล้ว และจะบอกตรงๆ ถ้าหาไม่เจอ';
$string['ask:placeholder'] = 'เช่น บทเรียนความปลอดภัยอยู่ตรงไหน';
$string['ask:send'] = 'ถาม';
...
$string['ask:note'] = 'ตอบจากหน้าที่คุณเปิดได้เท่านั้น มองไม่เห็นคะแนนหรือผลสอบของคุณ และไม่ตัดสินอะไรทั้งสิ้น';
...
$string['ai:offpremises'] = 'ปลายทางของโมเดลอยู่นอกเครือข่ายคุณ ข้อมูลกิจกรรมผู้เรียน — ชื่อเหตุการณ์และจำนวนครั้ง ไม่ใช่ภาพหรือค่าวัดใบหน้า — จะถูกส่งออกไป ตรวจให้แน่ใจก่อนเปิดว่าอยู่ในขอบเขตของเอกสารความยินยอมและสัญญาประมวลผลข้อมูลแล้ว';
$string['ai:brokenwhileon'] = 'ผู้ช่วย AI เปิดอยู่ แต่ไม่มีโมเดลตอบ ทุกครั้งที่เรียกใช้จะล้มเหลวจนกว่าจะแก้';
$string['ai:note'] = 'บริการไม่เคยได้รับภาพ คลิป ค่าวัดใบหน้า หรือชื่อคน และจะปฏิเสธ payload ที่มีสิ่งเหล่านั้น สิ่งที่มันตอบกลับไม่ได้ตัดสินอะไรทั้งสิ้น';
