...
//
// mod_interactivevideo does this well and is still installed alongside. What
// it cannot do is be ours: the customer has to be able to audit all three
// pieces they are buying, and a third-party GPL-3 plugin can be read but not
// answered for. We cannot promise a fix date on somebody else's issue tracker.
//
